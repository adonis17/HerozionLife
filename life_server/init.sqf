...
aiSpawn = ["hunting_zone",300] spawn TON_fnc_huntingZone;
aiSpawnt1 = ["turtle_1",100] spawn TON_fnc_huntingZonet1;
aiSpawnt2 = ["turtle_3",100] spawn TON_fnc_huntingZonet2;
