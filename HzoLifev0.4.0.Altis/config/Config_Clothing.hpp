...
class Clothing {
    class bruce {
        ...
        uniforms[] = {
			...
			{ "woman4", "", 5000, "" },
			//Radiation------------------
			{ "TRYK_U_B_PCUHsW5", "Anti Radiation", 25000, "" }
        };
        headgear[] = {
        ...
        goggles[] = {
            ...
            { "G_Lady_Dark", "", 150, "" },
            { "G_Lady_Blue", "", 150, "" },
			{ "TRYK_US_ESS_Glasses_WH", "Anti Radiation", 1500, "" }
        };
        vests[] = {
            { "NONE", $STR_C_Remove_vests, 0, "" },
			{ "TAC_Jvest_B", "Anti Radiation", 15000, "" }
        };
        backpacks[] = {
    ...
    class cop {
        ...
        uniforms[] = {
			...
			{ "U_B_GEN_Soldier_F", "", 1250, "call life_coplevel >= 2" },
			{ "gign_uniform", "", 1250, "call life_coplevel >= 8" },
        ...
        headgear[] = {
			...
			{ "H_MilCap_gen_F", "", 1200, "call life_coplevel >= 2" },
			{ "ALE_H_Calot", "", 1200, "call life_coplevel >= 2" },
			{ "gign_helm", "", 1200, "call life_coplevel >= 8" }
        };
        goggles[] = {
            { "NONE", $STR_C_Remove_goggles, 0, "" },
            { "G_Squares", "", 10, "" },
        ...
        vests[] = {
			...
			{ "V_TacVest_gen_F", "", 1500, "call life_coplevel >= 2" },
			{ "gign_BlackVest", "", 1500, "call life_coplevel >= 8" },
			{ "V_RebreatherB", "", 1500, "call life_coplevel >= 8" }
        };
        backpacks[] = {
            { "NONE", $STR_C_Remove_backpacks, 0, "" },
            { "B_FieldPack_cbr", "", 500, "" },
    ...
    class reb {
        ...
        uniforms[] = {
			...
			{ "Woman_Uniform1", "", 50020, "" },
			{ "Woman_Uniform2", "", 50020, "" },
			//MOD VETEMENT ----------------Niveau 1 Rebelle------------------
			{ "TRYK_U_B_BLKBLK_CombatUniform", "", 50020, "" },
			{ "TRYK_U_B_PCUHsW3", "", 50020, "" },
			{ "TRYK_U_B_BLKTAN_CombatUniform", "" },
			{ "U_I_C_Soldier_Para_1_F", "", 50020, "" },
			{ "rds_uniform_Woodlander4", "", 50020, "" },
			//MOD VETEMENT ----------------Niveau 2 Rebelle -------------------
			{ "TRYK_U_B_ACU", "", 50020, "call life_reblevel >= 1" },
			{ "TRYK_U_B_3CD_Ranger_BDU", "", 50020, "call life_reblevel >= 1" },
			{ "TRYK_U_B_MARPAT_Wood_Tshirt", "", 50020, "call life_reblevel >= 1" },
			{ "TRYK_U_B_OD_OD_CombatUniform", "", 50020, "call life_reblevel >= 1" },
			{ "U_O_FullGhillie_lsh", "", 50020, "call life_reblevel >= 1" },
			//MOD VETEMENT ----------------- Niveau 3 Rebelle -----------------
			{ "TRYK_U_B_TANTAN_CombatUniform", "", 50020, "call life_reblevel >= 2" },
			{ "TRYK_ZARATAKI", "", 50020, "call life_reblevel >= 2" },
			{ "TRYK_U_B_PCUODs", "", 50020, "call life_reblevel >= 2" },
			{ "TRYK_U_B_JSDF_CombatUniformTshirt", "", 50020, "call life_reblevel >= 2" },
			{ "U_I_C_Soldier_Bandit_3_F", "", 50020, "call life_reblevel >= 2" }
        };
        headgear[] = {
            { "NONE", $STR_C_Remove_headgear, 0, "" },
            { "H_Bandanna_camo", "", 650, "" },
			...
			//MOD MASQUE ----------------------
			{ "rds_Woodlander_cap1", "", 850, "" },
			{ "rds_Woodlander_cap2", "", 850, "" },
			{ "rds_Woodlander_cap3", "", 850, "" },
			{ "rds_Woodlander_cap4", "", 850, "" },
			{ "TRYK_H_headsetcap_Glasses", "", 850, "" },
			{ "TRYK_H_headsetcap_blk_Glasses", "", 850, "" },
			{ "Masque_Aubrey", "", 850, "" },
			{ "Masque_Bonnie", "", 850, "" },
			{ "Masque_Dallas", "", 850, "" },
			{ "Masque_Religieuse", "", 850, "" },
			{ "H_Booniehat_khk", "", 850, "" },
			{ "H_Booniehat_oli", "", 850, "" },
			{ "mgsr_headbag", "", 850, "" }
        };
        ...
        vests[] = {
			...
			{ "TAC_V_CTBA", "", 17500, "" },
			{ "TAC_V_Sheriff_BA_TC2", "", 17500, "" },
			{ "TAC_V_Sheriff_BA_T3", "", 17500, "" },
			{ "TAC_SEAL_RRV27_AOR1", "", 17500, "" },
			{ "TRYK_V_PlateCarrier_blk", "", 17500, "" }
        };
        backpacks[] = {
            { "NONE", $STR_C_Remove_backpacks, 0, "" },
            { "B_OutdoorPack_blk", "", 500, "" },
