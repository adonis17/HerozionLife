...
/* Database Related Settings */
    ...
    saved_virtualItems[] = {"tel", "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" }; //Array of virtual items that can be saved on your player.
    ...
    save_vehicle_items[] = {"tel", "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" };
...
/* System Settings */
    ...
    vehicle_storage_fee_multiplier = 0.005; //Pull from garage cost --> Cost takes the playersides Buy Price * multiplier
	...
	vehicle_insurance_multiplier_CIVILIAN = .4; //Civilian Vehicle Insurance Price = Vehicle Buy Price * multiplier 
