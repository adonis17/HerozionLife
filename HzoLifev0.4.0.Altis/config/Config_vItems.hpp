...
class VirtualShops {
    ...
    class market {
        ...
        side = "civ";
        conditions = "";
        items[] = { "tel", "waterBottle", "rabbit", "apple", "redgull", "tbacon", "pickaxe", "toolkit", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw" };
    };
    ...
    class rebel {
        ...
        items[] = {"tel","handcuffkeys", "handcuff", "waterBottle", "rabbit", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "toolkit", "fuelFull", "peach", "boltcutter", "blastingcharge" };
    };
    ...
    class drugdealer {
        ...
        side = "civ";
        conditions = "";
        items[] = { "cocaine_processed", "heroin_processed", "marijuana", "mushroom", "tobacco_processed", "ecstasy" };
    };
    ...
    class cop {
        ...
        side = "cop";
        conditions = "";
        items[] = { "tel","handcuffkeys", "handcuff","donuts", "coffee", "spikeStrip", "waterBottle", "rabbit", "apple", "redgull", "toolkit", "fuelFull", "defusekit", "defibrillator" };
    };
	...
	class dep {
        name = "STR_Shops_dep";
        side = "civ";
        license = "license_civ_depanneur";
        level[] = { "", "", -1, "" };
        items[] = { "tel", "waterBottle", "rabbit", "apple", "redgull", "tbacon", "toolkit", "fuelFull" };
    };
};
...
class VirtualItems {
	...
	class handcuffkeys {
        ...
        displayName = "STR_Item_clémenotte";
        weight = 4;
        buyPrice = 15;
		sellPrice = -1;
        illegal = true;
	...
	class tel {
        variable = "tel";
        displayName = "STR_Item_tel";
        weight = 1;
        buyPrice = 799;
        sellPrice = -1;
        illegal = false;
        edible = -1;
        icon = "icons\Telephone.paa";
    };
	...
	class mdma_ecstasy { 
        variable = "mdmaEcstasy"; 
        displayName = "STR_Item_MDMAEcstasy"; 
        weight = 5; 
        buyPrice = -1;
        sellPrice = -1; 
        illegal = true; 
        edible = -1; 
        icon = "icons\ico_mdma.paa"; 
    ...
    class goat {
	 ...
	 class mushroom {
        variable = "mushroom";
        displayName = "STR_Item_Mushroom";
        weight = 4;
        buyPrice = 1750;
        sellPrice = -1; 
        illegal = true;
        edible = -1;
        icon = "icons\Mshroom.paa";
    };	
	
	class Dent {
        variable = "Dent";
        displayName = "STR_Item_Dent";
        weight = 2;
        buyPrice = -1;
        sellPrice = -1; 
        illegal = true;
    ...
    class Bague {
        ...
        illegal = true;
        edible = -1;
        icon = "icons\Bague.paa";
    };	

    class Os {
        variable = "OS";
        displayName = "STR_Item_OS";
        weight = 2;
        buyPrice = -1;
        sellPrice = -1; 
        illegal = true;
